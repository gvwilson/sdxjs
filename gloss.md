...
<dd class="glossary">A <g key="design_pattern">design pattern</g> in which an <g key="object">object</g> does most of the work to complete a task, but uses one of a set of other objects to complete some specific parts of the work. Delegation is often used instead of inheritance to customize objects' behavior.</dd>
...
<dd class="glossary">A single value of a particular type, such as 1 or &quot;a&quot;. Scalars exist in several languages, but do not really exist in <g key="r_language">R</g>; values that appear to be scalars are actually <g key="vector">vectors</g> of unit length.</dd>
