...
<dt id="mixin-class" class="glossary">mixin class</dt>
<dd class="glossary">A class that provides methods for other classes to use without being in the inheritance hierarchy.</dd>
