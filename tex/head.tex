...
\newenvironment{callout}{\begin{tBox}\begin{quotation}\toggletrue{inshade}\renewcommand{\thempfootnote}{\arabic{footnote}}}{\end{quotation}\end{tBox}\togglefalse{inshade}}
