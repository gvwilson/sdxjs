...
<%- include('/_inc/multi.html', {pat: 'replace-func.*', fill: 'js txt'}) %>
...
<%- include('/_inc/multi.html', {pat: 'func-def.*', fill: 'js txt'}) %>

-   Pick out some nodes and see if we can generate code from a handmade AST

<%- include('/_inc/multi.html', {pat: 'one-plus-two.*', fill: 'js txt'}) %>
...
<%- include('/_inc/multi.html', {pat: 'multi-func-counter.*', fill: 'js txt'}) %>
...
<%- include('/_inc/multi.html', {pat: 'test-time-func.*', fill: 'js txt'}) %>
