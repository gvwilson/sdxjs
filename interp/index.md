...
As an experiment,
we wrote a custom [%g loader "module loader" %]
...
but C and C++ do this
with [%g header_file "header files" %],
and static site generators
([%x templater %]) do this to share fragments of HTML.
...
(We will actually do that in [%x style %],
...
Browsers do their best to run code in a [%g sandbox "sandbox" %] for safety,
but Node doesn't,
...
[%inc import-interpolate.js %]

and subfiles like this:


[%inc import-interpolate-topmethod.js %]

and this:


[%inc import-interpolate-bottommethod.js %]
...
[%g literate_programming "Literate programming" %] was invented
...
only implement part of [Donald Knuth's][knuth_donald] original vision.
