...
uses the systems programming skills of [%x sysprog %].
...
It is based in part on [this tutorial][package_manager_tutorial] by [Maël Nison][nison_mael].
...
for every package P.
The general-purpose tools for doing this are called [%g sat_solver "SAT solvers" %]
...
Most software projects use [%g semantic_versioning "semantic versioning" %] for software releases.
Each version number consists of three integers X.Y.Z,
where X is the major version,
Y is the minor version,
and Z is the [%g patch "patch" %] number.
...
is [%g backward_compatible "backward-compatible" %]---i.e.,
...
<div id="t:package-manager-example-dependencies" data-caption="Example package dependencies." markdown="1">
| Package | Requires |
| ------- | -------- |
| X/1     | Y/1-2    |
| X/1     | Z/1      |
...
<div id="t:package-manager-example-result" data-caption="Result for example package dependencies." markdown="1">
|   X |   Y |   Z | Excluded  |
| --- | --- | --- | --------- |
|   1 |   1 |   1 | Y/1 - Z/1 |
|   1 |   1 |   2 | X/1 - Z/2 |
...
a [%g combinatorial_explosion "combinatorial explosion" %] of possibilities.
...
a real package manager would read the [%g manifest "manifests" %] of the packages in question
...
<div id="t:package-manager-exclusions" data-caption="Package exclusions." markdown="1">
| Excluded  |   X |   Y |   Z |
| --------  | --- | --- | --- |
| X/1 - Y/3 |   1 |   3 |   1 |
| …         |   1 |   3 |   2 |
...
We can make this more efficient by [%g prune "pruning" %] the search tree
as we go along
...
Using the techniques of [%x parser %],
