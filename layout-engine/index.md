...
<%- include('/inc/code.html', {file: 'test/test-easy-mode.js'}) %>
...
<%- include('/inc/code.html', {file: 'placed-block.js'}) %>
<%- include('/inc/code.html', {file: 'placed-row.js'}) %>
<%- include('/inc/code.html', {file: 'placed-column.js'}) %>
<%- include('/inc/code.html', {file: 'test/test-placed.js'}) %>
...
<%- include('/inc/code.html', {file: 'micro-dom.js'}) %>
...
<%- include('/inc/code.html', {file: 'micro-css.js'}) %>
