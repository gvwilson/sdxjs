...
In the early 2000s,
the University of Toronto asked [Greg Wilson][wilson_greg]
...
Frustrated by that,
he and [Andy Oram][oram_andy] persuaded some well-known programmers to contribute a chapter each
...
To fix that,
Greg Wilson, [Amy Brown][brown_amy],
[Tavish Armstrong][armstrong_tavish],
and [Mike DiBernardo][dibernardo_mike]
