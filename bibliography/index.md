...
<span id="Binkley2012">Binkley2012</span>
...
<span id="Brand1995">Brand1995</span>
:   Stewart Brand:
    *How Buildings Learn: What Happens After They're Built*.
    Penguin USA,
    1995,
    [9780140139969](https://isbnsearch.org/isbn/9780140139969).
...
:   Amy Brown and Greg Wilson (eds.):
    *The Architecture of Open Source Applications: Elegance, Evolution, and a Few Fearless Hacks*.
    Lulu,
    2011,
    [9781257638017](https://isbnsearch.org/isbn/9781257638017).
...
:   Amy Brown and Greg Wilson (eds.):
    *The Architecture of Open Source Applications: Structure, Scale, and a Few More Fearless Hacks*.
    Lulu,
    2012,
    [9780201103427](https://isbnsearch.org/isbn/9780201103427).
...
:   Amy Brown and Michael DiBernardo (eds.):
    *500 Lines or Less: Experienced Programmers Solve Interesting Problems*.
    Lulu,
    2016,
    [9781329871274](https://isbnsearch.org/isbn/9781329871274).

<span id="Casciaro2020">Casciaro2020</span>
:   Mario Casciaro and Luciano Mammino:
    *Node.js Design Patterns*.
    Packt,
    2020,
    [9781839214110](https://isbnsearch.org/isbn/9781839214110).

<span id="Conery2021">Conery2021</span>
:   Rob Conery:
    *The Imposter's Handbook: A CS Primer for Self-Taught Developers*.
    Independently published,
    2021,
    [9788708185266](https://isbnsearch.org/isbn/9788708185266).

<span id="Davis2018">Davis2018</span>
:   Ashley Davis:
    *Data Wrangling with JavaScript*.
    Manning,
    2018,
    [9781617294846](https://isbnsearch.org/isbn/9781617294846).

<span id="Feathers2004">Feathers2004</span>
:   Michael C. Feathers:
    *Working Effectively with Legacy Code*.
    Prentice-Hall,
    2004,
    [9780131177055](https://isbnsearch.org/isbn/9780131177055).
...
<span id="Gregg2020">Gregg2020</span>
:   Brendan Gregg:
    *Systems Performance: Enterprise and the Cloud*.
    Pearson,
    2020,
    [9780136820154](https://isbnsearch.org/isbn/9780136820154).

<span id="Johnson2019">Johnson2019</span>
...
:   Brian W. Kernighan and P. J. Plauger:
    *The Elements of Programming Style*.
    McGraw-Hill,
    1979,
    [9780070342071](https://isbnsearch.org/isbn/9780070342071).
...
:   Brian W. Kernighan and Rob Pike:
    *The Unix Programming Environment*.
    Prentice-Hall,
    1983,
    [9780139376818](https://isbnsearch.org/isbn/9780139376818).
...
:   Brian W. Kernighan and Dennis M. Ritchie:
    *The C Programming Language*.
    Prentice-Hall,
    1988,
    [9780131103627](https://isbnsearch.org/isbn/9780131103627).

<span id="Kohavi2020">Kohavi2020</span>
:   Ron Kohavi, Diane Tang, and Ya Xu:
    *Trustworthy Online Controlled Experiments: A Practical Guide to A/B Testing*.
    Cambridge University Press,
    2020,
    [9781108724265](https://isbnsearch.org/isbn/9781108724265).

<span id="Meszaros2007">Meszaros2007</span>
:   Gerard Meszaros:
    *xUnit Test Patterns: Refactoring Test Code*.
    Addison-Wesley,
    2007,
    [9780131495050](https://isbnsearch.org/isbn/9780131495050).
...
:   Andy Oram and Greg Wilson (eds.):
    *Beautiful Code: Leading Programmers Explain How They Think*.
    O'Reilly,
    2007,
    [9780596510046](https://isbnsearch.org/isbn/9780596510046).

<span id="Osmani2017">Osmani2017</span>
:   Addy Osmani:
    *Learning JavaScript Design Patterns*.
    https://addyosmani.com/resources/essentialjsdesignpatterns/book/,
    2017.

<span id="Patterson2017">Patterson2017</span>
:   David A. Patterson and John L. Hennessy:
    *Computer Organization and Design: The Hardware/Software Interface*.
    Morgan Kaufmann,
    2017,
    [9780128122754](https://isbnsearch.org/isbn/9780128122754).
...
:   Marian Petre and André van der Hoek:
    *Software Design Decoded: 66 Ways Experts Think*.
    MIT Press,
    2016,
    [9780262035187](https://isbnsearch.org/isbn/9780262035187).

<span id="Petzold2008">Petzold2008</span>
:   Charles Petzold:
    *The Annotated Turing*.
    Wiley,
    2008,
    [9780470229057](https://isbnsearch.org/isbn/9780470229057).
...
:   Donald A. Schon:
    *The Reflective Practitioner: How Professionals Think in Action*.
    Basic Books,
    1984,
    [9780465068784](https://isbnsearch.org/isbn/9780465068784).

<span id="Smith2011">Smith2011</span>
:   Peter Smith:
    *Software Build Systems: Principles and Experience*.
    Addison-Wesley Professional,
    2011,
    [9780134185965](https://isbnsearch.org/isbn/9780134185965).
...
<span id="Tudose2020">Tudose2020</span>
:   Cătălin Tudose:
    *JUnit in Action*.
    Manning,
    2020,
    [9781617297045](https://isbnsearch.org/isbn/9781617297045).
