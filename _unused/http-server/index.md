...
<%- include('/_inc/file.html', {file: 'simple-socket-client.js'}) %>

-   A very simple socket server

<%- include('/_inc/file.html', {file: 'simple-socket-server.js'}) %>
...
<%- include('/_inc/multi.html', {pat: 'run-simple-socket.*', fill: 'sh txt'}) %>
...
<%- include('/_inc/file.html', {file: 'socket-server.js'}) %>
...
<%- include('/_inc/file.html', {file: 'always-send-success.js'}) %>

-   Try running

<%- include('/_inc/multi.html', {pat: 'always-send-success.*', fill: 'sh txt'}) %>
...
<%- include('/_inc/file.html', {file: 'http-response-success.js'}) %>
...
<%- include('/_inc/file.html', {file: 'http-response-browser.txt'}) %>
...
<%- include('/_inc/file.html', {file: 'http-request-client.js'}) %>

-   Run the server and the client
    -   Server only sees what we send

<%- include('/_inc/file.html', {file: 'http-response-success.txt'}) %>
...
<%- include('/_inc/file.html', {file: 'test/socket.js'}) %>

-   Unit test

<%- include('/_inc/file.html', {file: 'test/test-http-response-success.js'}) %>

-   Parse the HTTP request and return text files

<%- include('/_inc/multi.html', {pat: 'http-response-parse.*', fill: 'js txt'}) %>
...
<%- include('/_inc/multi.html', {pat: 'breaking-sandbox.*', fill: 'sh txt'}) %>
...
<%- include('/_inc/file.html', {file: 'base-http-server.js'}) %>
<%- include('/_inc/multi.html', {pat: 'test-base-http-server.*', fill: 'js sh txt'}) %>

-   Serve files

<%- include('/_inc/file.html', {file: 'http-file-server.js'}) %>
<%- include('/_inc/multi.html', {pat: 'test-http-file-server.*', fill: 'sh txt'}) %>
...
<%- include('/_inc/file.html', {file: 'http-params-server.js'}) %>

-   Client builds a query string
    -   Should use a library (there are many)

<%- include('/_inc/file.html', {file: 'http-params-client.js'}) %>

-   Testing

<%- include('/_inc/multi.html', {pat: 'test-http-params-server.*', fill: 'sh txt'}) %>
...
<%- include('/_inc/file.html', {file: 'got-json-client.js'}) %>
