...
<dt id="chunk" class="glossary">chunk (in memory)</dt>
<dd class="glossary">A set of things that are remembered together, such as the pattern of spots on a card or a die. A chunk only takes up on spot in <g key="working_memory">working memory</g>.</dd>
...
<dt id="long_term_memory" class="glossary">long-term memory</dt>
<dd class="glossary">The subsystem in our brains that remembers things permanently (or nearly so). We do not have direct conscious access to long-term memory; instead, we constantly load things from it into <g key="working_memory">working memory</g>.</dd>
...
<dt id="short_term_memory" class="glossary">short-term memory</dt>
<dd class="glossary">See <g key="working_memory">working memory</g>.</dd>
...
<dt id="working_memory" class="glossary">working memory</dt>
<dd class="glossary">The portion of memory to which someone has direct conscious access. People constantly bring things from <g key="long_term_memory">long-term memory</g> into working memory to use.</dd>
