% \documentclass[krantzl,luluexecutive]{tex/krantz}
\documentclass[krantzl,letterpaper]{tex/krantz}
...
% Chapter ledes.
\newcommand{\chapterlede}[1]{\begin{center}\textbf{\emph{#1}}\end{center}}
